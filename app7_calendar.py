...
def update_graph(selected_year,selected_sexe):
    ...
    return f"Total décès: {total_enreg_death}", f"Décès hommes: {hommes_death}", f"Décès femmes: {femmes_death}",f"Total Naissances: {total_enreg_birth}", f"Naissances Garçons: {hommes_birth}", f"Naissances Filles: {femmes_birth}", fig_moustache, fig_birth, fig_death_mois, fig_death_year, fig_choro_birth, fig_choro_death, fig_calendar
