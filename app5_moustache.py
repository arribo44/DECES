...
app.layout = dbc.Container(
    children=[
        ...
        dbc.Row([
            ...
            dbc.Col(
                dbc.Button("Total naissances", id="total-indicator-birth", color="danger", className="me-1",
                           style={'width': '100%'}),
                width=4
            ),
            ...
            dbc.Col(
                dbc.Button("Total naissances Garçons", id="homme-indicator-birth", color="primary", className="me-1",
                           style={'width': '100%'}),
                width=4
            ),
            ...
            dbc.Col(
                dbc.Button("Total naissances Filles", id="femme-indicator-birth", color="warning", style={'width': '100%'}),
                width=4
            ),
...
def update_graph(selected_year):
    ...
    # Boîte pour les hommes (s'il y en a dans les données)
    ...
    return f"Total Naissances: {total_enregistrements}", f"Naissances Garçons: {hommes}", f"Naissances Filles: {femmes}", fig_moustache, fig_birth, fig_death_mois, fig_death_year, fig_choro_birth
